    ...
    <nav class="navbar navbar-inverse navbar-static-top" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="navegador">
        ...
        <div id="nombredeusuario" class= "col-sm-1">
               <button type="submit" class="nombreusuario"><img src="../app/webroot/img/logousuario.png"></img>    &nbsp<?php echo $this->Html->link('Nombre Usuario',array('controller'=>'users','action'=>'index')); ?>
               </button>
